...
#Pretty simple, recursive method call is commonly used in directory traverse.
#Can take one parameter $1 to restrict max depth of dir.

# Be familiar with this, you may use it in your own scripts.
