...
# Then you can use sdcv to search meaning of every word.
...
# Zf comments:
# '\012' is newline.
# tr -c '\012a-z';   -c means use the complement of the attached character set.
# It turns out to using '\012' which means newline, to substitute every none alphabet, none newline characters.